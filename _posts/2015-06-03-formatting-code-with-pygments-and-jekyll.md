...
This blog is generated by [Jekyll](http://jekyllrb.com) and uses [Pygments](http://pygments.org) to highlight code syntax.  This post describes the process I used to setup Pygments and style code snippets.  *[Update: For formatting code blocks with Jekyll version 3 please see [formatting code with jekyll 3 and bootstrap](/blog/webdev/formatting-code-with-jekyll3-and-bootstrap/)]* *[Update 2: [Github has updated to Jekyll 3](https://github.com/blog/2100-github-pages-now-faster-and-simpler-with-jekyll-3-0), so this site now uses Jekyll 3 and the rouge highlighter.]*
